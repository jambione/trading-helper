...
| `bollinger_cross_study.py` | Bollinger %B / bandwidth (1m and 5m) at −50 crosses as a ranking input? (2026-09-25) | No: %B flips between halves; 5m bandwidth same sign but weak by symbol-day. Room below HOD beats all BB measures (both halves, by symbol-day, 7/7 days). See docs/BOLLINGER_STUDY_2026-09-25.md |
