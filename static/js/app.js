...
import { connect, on, api }                      from './api.js?v=100';
import { subscribe, set }                        from './store.js?v=100';
import { init as initFeeds }                     from './feeds.js?v=100';
import { init as initTickers }                   from './tickers.js?v=100';
import { init as initTradingView }               from './tradingview.js?v=100';
import { init as initConfig, open as openConfig, updateFeedbackBadge } from './config.js?v=100';
import { init as initResizer }                   from './resizer.js?v=100';
import * as controls                             from './controls.js?v=100';
import * as notifications                        from './notifications.js?v=100';
import { isAuthenticated, logout, getQueryUser } from './auth.js?v=100';
import { init as initNews }                      from './news.js?v=100';
import { init as initLeaderboard }               from './leaderboard.js?v=100';
import { init as initPriceSpikes }               from './priceSpikes.js?v=100';
import { init as initEngine }                    from './engine.js?v=100';
import { init as initAdmin, open as openAdmin }  from './admin.js?v=100';
import { init as initHotkeys, registerHotkey }   from './hotkeys.js?v=100';
import { init as initSessions, refresh as refreshSessions } from './sessions.js';
import { init as initMobilePager }                from './mobilePager.js?v=100';
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const _addFeedItem = async () => {
    ...
    if (!text) return;
    const m = await import('./admin.js?v=100');
