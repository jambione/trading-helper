...
import { connect, on, api }                      from './api.js?v=58';
import { subscribe, set }                        from './store.js?v=58';
import { init as initTranscription }             from './transcription.js?v=58';
import { init as initTickers }                   from './tickers.js?v=58';
import { init as initTradingView }               from './tradingview.js?v=58';
import { init as initConfig, open as openConfig, updateFeedbackBadge } from './config.js?v=58';
import { init as initResizer }                   from './resizer.js?v=58';
import * as controls                             from './controls.js?v=58';
import * as notifications                        from './notifications.js?v=58';
import { isAuthenticated, logout, getQueryUser } from './auth.js?v=58';
import { init as initNews }                      from './news.js?v=58';
import { init as initLeaderboard }               from './leaderboard.js?v=58';
import { init as initEngine }                    from './engine.js?v=58';
import { init as initAdmin, open as openAdmin }  from './admin.js?v=58';
import { init as initHotkeys, registerHotkey }   from './hotkeys.js?v=58';
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const _addFeedItem = async () => {
    ...
    if (!text) return;
    const m = await import('./admin.js?v=58');
