...
DEFAULT_CONFIG = {
    ...
    # Opening cushion is give_open_r (0.20R); it interpolates down to
    # give_r (0.10R) as MFE reaches tighten_mfe_r (0.5R). give_px > 0 is
    # a legacy fixed dollar and overrides the calculation.
