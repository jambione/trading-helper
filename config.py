...
DEFAULT_CONFIG = {
    ...
    # Phase B — premarket session extension (Hybrid C). Default OFF / dry.
    # Design: docs/PHASE_B_PREMARKET.md. Does not enable Plan B burst or
    # flip global ai_premarket_working_sell for RTH flats.
    "ai_phase_b_enabled":                 False,
    ...
    "ai_phase_b_working_sell":            True,  # scoped to phase_b positions only
    "ai_phase_b_chase_step_sec":          2.5,
    ...
    # Elite-6 pins + scout seats. Pins stay on the book all day (sync keep +
    # steal protect); scouts audition via soft-seed / warming. 0 pin_slots
    # disables the pin class. Scout seats default to warming_seats when unset.
    "ai_watch_pin_slots": 6,
    "ai_watch_scout_seats": 3,
    "ai_watch_pin_min_dollar_volume": 2_000_000.0,
...
_EFFECTIVE_KEYS = (
    ...
    "ai_phase_b_enabled",
    "ai_phase_b_dry_run",
    "ai_phase_b_working_sell",
    "ai_phase_b_no_rth_handoff",
    "ai_phase_b_ledger_enabled",
    "desk_product",
    "ai_h4_paper",
    "ai_h3_paper",
    "ai_late_hold_paper",
