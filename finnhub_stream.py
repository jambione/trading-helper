...
# The tier's ceiling. The 50-subscription hangs of 2026-09-23/24 were the
# cap-hit deadlock in _drain_pending (fixed: FinnhubState.lock is an RLock),
# not the count. A 40 cap (a61db23) starved ~13 book names of live
# dashboard quotes; CDNA was evicted stale while the engine had it live.
# The env override is read at import, before dashboard.py loads
# signal_engine.env, so the default is the value that binds.
