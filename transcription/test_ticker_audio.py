...
_ROOT = Path(__file__).resolve().parent.parent  # repo root (this test lives in tests/)

# ── Audio file ─────────────────────────────────────────────────────────────
mp3 = Path(sys.argv[1]) if len(sys.argv) > 1 else (_ROOT / "samples" / "ticker 1.mp3")
...
tx_path = _ROOT / "transcription" / "transcribe_action.py"
...
_uni_file = _ROOT / "transcription" / "ticker_universe.json"
